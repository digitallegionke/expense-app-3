...
type TabIconProps = IconProps & { bg?: string; active?: boolean };

export function HomeTabIcon({ size = 24, color = '#69508C', bg = '#DEDBF1', active = true }: TabIconProps) {
  if (active) {
    return (
  ...
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24">
      <Path
        d="M0.000 11.616C0.000 11.381 0.049 11.148 0.142 10.933C0.236 10.717 0.373 10.523 0.545 10.363C0.545 10.363 11.443 0.206 11.443 0.206C11.598 0.073 11.796 0.000 12.000 0.000C12.204 -0.000 12.402 0.073 12.557 0.206C12.557 0.206 23.455 10.363 23.455 10.363C23.627 10.523 23.764 10.717 23.858 10.933C23.951 11.148 24.000 11.381 24.000 11.616C24.000 11.616 24.000 21.429 24.000 21.429C24.000 22.111 23.729 22.765 23.247 23.247C22.765 23.729 22.111 24.000 21.429 24.000C21.429 24.000 2.571 24.000 2.571 24.000C1.889 24.000 1.235 23.729 0.753 23.247C0.271 22.765 0.000 22.111 0.000 21.429C0.000 21.429 0.000 11.616 0.000 11.616Z"
        fill={bg}
      />
      <Path
        transform="translate(10.286, 17.143)"
        d="M3.429 6.857C3.429 6.857 0.000 6.857 0.000 6.857C0.000 6.857 0.000 1.714 0.000 1.714C0.000 1.260 0.181 0.824 0.502 0.502C0.824 0.181 1.260 0.000 1.714 0.000C2.169 0.000 2.605 0.181 2.926 0.502C3.248 0.824 3.429 1.260 3.429 1.714C3.429 1.714 3.429 6.857 3.429 6.857Z"
        fill={color}
      />
    </Svg>
  );
...
export function ReceiptTabIcon({ size = 24, color = '#69508C', bg = '#DEDBF1', active = false }: TabIconProps) {
  if (active) {
    return (
      <Svg width={size} height={size} viewBox="0 0 24 24">
        <Path
          d="M4.286 0.000C3.149 0.000 2.059 0.452 1.255 1.255C0.452 2.059 0.000 3.149 0.000 4.286C0.000 4.286 0.000 23.143 0.000 23.143C-0.000 23.295 0.040 23.443 0.117 23.575C0.193 23.706 0.303 23.814 0.435 23.889C0.566 23.964 0.716 24.002 0.868 24.000C1.019 23.998 1.168 23.956 1.298 23.878C1.298 23.878 5.143 21.571 5.143 21.571C5.143 21.571 8.988 23.878 8.988 23.878C9.121 23.958 9.273 24.000 9.429 24.000C9.584 24.000 9.736 23.958 9.869 23.878C9.869 23.878 13.714 21.571 13.714 21.571C13.714 21.571 17.559 23.878 17.559 23.878C17.690 23.956 17.838 23.998 17.990 24.000C18.141 24.002 18.291 23.964 18.423 23.889C18.555 23.814 18.664 23.706 18.741 23.575C18.817 23.443 18.857 23.295 18.857 23.143C18.857 23.143 18.857 10.286 18.857 10.286C18.857 10.286 18.866 10.286 18.866 10.286C18.866 10.286 18.866 4.286 18.866 4.286C18.866 4.002 18.979 3.729 19.180 3.528C19.380 3.327 19.653 3.214 19.937 3.214C20.221 3.214 20.494 3.327 20.695 3.528C20.896 3.729 21.009 4.002 21.009 4.286C21.009 4.286 21.009 10.286 21.009 10.286C21.009 10.286 23.143 10.286 23.143 10.286C23.370 10.286 23.588 10.195 23.749 10.035C23.910 9.874 24.000 9.656 24.000 9.429C24.000 9.429 24.000 3.429 24.000 3.429C24.000 2.519 23.639 1.647 22.996 1.004C22.353 0.361 21.481 0.000 20.571 0.000C20.571 0.000 4.286 0.000 4.286 0.000ZM15.110 8.561C15.226 8.435 15.316 8.287 15.374 8.125C15.432 7.964 15.458 7.792 15.448 7.621C15.439 7.450 15.396 7.282 15.321 7.128C15.246 6.973 15.141 6.835 15.012 6.722C14.883 6.609 14.732 6.523 14.569 6.469C14.406 6.415 14.234 6.394 14.063 6.408C13.892 6.421 13.726 6.469 13.573 6.548C13.421 6.627 13.286 6.735 13.176 6.867C13.176 6.867 7.961 12.828 7.961 12.828C7.961 12.828 5.486 10.971 5.486 10.971C5.351 10.870 5.197 10.796 5.033 10.755C4.870 10.713 4.700 10.703 4.532 10.727C4.365 10.751 4.205 10.808 4.059 10.894C3.914 10.980 3.787 11.093 3.686 11.229C3.584 11.364 3.511 11.517 3.469 11.681C3.427 11.844 3.418 12.015 3.441 12.182C3.465 12.349 3.522 12.510 3.608 12.655C3.694 12.800 3.808 12.927 3.943 13.029C3.943 13.029 7.371 15.600 7.371 15.600C7.631 15.794 7.954 15.884 8.276 15.850C8.599 15.816 8.896 15.662 9.110 15.418C9.110 15.418 15.110 8.561 15.110 8.561Z"
          fillRule="evenodd"
          fill={color}
        />
      </Svg>
...
export function CoinsTabIcon({ size = 24, color = '#69508C', bg = '#DEDBF1', active = false }: TabIconProps) {
  if (active) {
    return (
      <Svg width={size} height={size} viewBox="0 0 23.79 24">
        <Path
          d="M0.000 9.571C0.000 9.571 0.000 12.490 0.000 12.490C0.000 14.150 2.657 15.545 6.218 15.854C6.218 15.854 6.218 11.510 6.218 11.510C6.218 11.510 6.223 11.304 6.223 11.304C4.246 11.163 2.446 10.743 1.035 10.114C0.679 9.956 0.333 9.775 0.000 9.571ZM15.429 3.429C15.429 3.429 15.429 5.949 15.429 5.949C13.310 6.019 11.319 6.429 9.749 7.128C8.889 7.510 8.059 8.023 7.414 8.698C7.269 8.853 7.126 9.021 6.996 9.201C4.961 9.125 3.185 8.726 1.910 8.157C1.197 7.839 0.686 7.488 0.369 7.154C0.198 6.989 0.071 6.784 0.000 6.557C0.000 6.557 0.000 3.429 0.000 3.429C0.000 1.534 3.453 0.000 7.714 0.000C11.974 0.000 15.429 1.534 15.429 3.429ZM7.714 5.025C10.689 5.025 13.101 4.332 13.101 3.477C13.101 2.619 10.689 1.927 7.713 1.927C4.738 1.927 2.326 2.621 2.326 3.477C2.326 4.332 4.740 5.025 7.714 5.025ZM8.361 20.571C8.361 20.571 8.361 17.652 8.361 17.652C8.683 17.851 9.031 18.033 9.398 18.195C11.155 18.981 13.512 19.438 16.075 19.438C18.636 19.438 20.995 18.981 22.752 18.195C23.119 18.033 23.467 17.853 23.789 17.652C23.789 17.652 23.789 20.571 23.789 20.571C23.789 22.457 20.361 24.000 16.075 24.000C11.789 24.000 8.361 22.457 8.361 20.571ZM8.731 15.235C8.560 15.071 8.432 14.866 8.361 14.640C8.361 14.640 8.361 11.510 8.361 11.510C8.361 9.617 11.815 8.081 16.075 8.081C20.335 8.081 23.789 9.617 23.789 11.510C23.789 11.510 23.789 14.640 23.789 14.640C23.718 14.867 23.590 15.072 23.419 15.237C23.102 15.571 22.593 15.922 21.879 16.241C20.457 16.875 18.408 17.297 16.075 17.297C13.742 17.297 11.695 16.875 10.270 16.241C9.557 15.922 9.048 15.571 8.731 15.235ZM21.461 11.558C21.461 12.415 19.049 13.107 16.075 13.107C13.099 13.107 10.689 12.413 10.689 11.558C10.689 10.702 13.099 10.008 16.075 10.008C19.049 10.008 21.461 10.702 21.461 11.558Z"
          fillRule="evenodd"
          fill={color}
        />
      </Svg>
...
export function ProfileTabIcon({ size = 24, color = '#69508C', bg = '#DEDBF1', active = false }: TabIconProps) {
  if (active) {
    return (
      <Svg width={size} height={size} viewBox="0 0 24 24">
        <Path
          d="M24.000 12.000C24.000 15.217 22.734 18.139 20.672 20.294C18.495 22.570 15.431 23.990 12.036 24.000C12.036 24.000 12.000 24.000 12.000 24.000C12.000 24.000 11.964 24.000 11.964 24.000C8.569 23.990 5.505 22.570 3.328 20.294C1.266 18.139 0.000 15.217 0.000 12.000C0.000 5.373 5.373 0.000 12.000 0.000C18.627 0.000 24.000 5.373 24.000 12.000ZM19.273 18.000C17.544 15.906 14.928 14.571 12.000 14.571C9.072 14.571 6.456 15.906 4.727 18.000C6.456 20.094 9.072 21.429 12.000 21.429C14.928 21.429 17.544 20.094 19.273 18.000ZM12.000 12.857C14.367 12.857 16.286 10.938 16.286 8.571C16.286 6.204 14.367 4.286 12.000 4.286C9.633 4.286 7.714 6.204 7.714 8.571C7.714 10.938 9.633 12.857 12.000 12.857Z"
          fillRule="evenodd"
          fill={color}
        />
      </Svg>
...
export function UserIcon({ size = 20, color = '#69508C' }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24">
      <Path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2" fill="none" stroke={color} strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
      <Circle cx={12} cy={7} r={4} fill="none" stroke={color} strokeWidth={2} />
    </Svg>
  );
}

export function LockIcon({ size = 20, color = '#69508C' }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24">
      <Rect x={3} y={11} width={18} height={11} rx={2} fill="none" stroke={color} strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
      <Path d="M7 11V7a5 5 0 0 1 10 0v4" fill="none" stroke={color} strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
    </Svg>
  );
}

export function PaletteIcon({ size = 20, color = '#69508C' }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24">
      ...
      <Circle cx={9.5} cy={15} r={1.3} fill={color} />
    </Svg>
  );
}

export function HelpCircleIcon({ size = 20, color = '#69508C' }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24">
      <Circle cx={12} cy={12} r={10} fill="none" stroke={color} strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
...
export function FileTextIcon({ size = 20, color = '#69508C' }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24">
      <Path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" fill="none" stroke={color} strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
...
export function LogOutIcon({ size = 20, color = '#E00303' }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24">
      <Path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4" fill="none" stroke={color} strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
      <Path d="M16 17l5-5-5-5" fill="none" stroke={color} strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
...
export function CameraIcon({ size = 16, color = '#FFFFFF' }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24">
      <Path d="M4 7h3l2-2h6l2 2h3a1 1 0 0 1 1 1v11a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V8a1 1 0 0 1 1-1Z" fill="none" stroke={color} strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
...
export function CheckIcon({ size = 16, color = '#FFFFFF' }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24">
      <Path d="M20 6L9 17l-5-5" fill="none" stroke={color} strokeWidth={2.5} strokeLinecap="round" strokeLinejoin="round" />
    </Svg>
  );
}

export function MailIcon({ size = 20, color = '#69508C' }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24">
      <Rect x={2} y={4} width={20} height={16} rx={2} fill="none" stroke={color} strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
      <Path d="m22 6-10 7L2 6" fill="none" stroke={color} strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
    </Svg>
  );
}

export function MessageCircleIcon({ size = 20, color = '#69508C' }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24">
      <Path d="M7.9 20A9 9 0 1 0 4 16.1L2 22Z" fill="none" stroke={color} strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
    </Svg>
  );
}

export function EyeIcon({ size = 20, color = '#666666' }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24">
...
export function EyeOffIcon({ size = 20, color = '#666666' }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24">
      <Path d="M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a13.16 13.16 0 0 1-1.67 2.68" fill="none" stroke={color} strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
      <Path d="M6.61 6.61A13.526 13.526 0 0 0 1 12s4 8 11 8a9.26 9.26 0 0 0 5.39-1.61" fill="none" stroke={color} strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
      <Path d="M14.12 14.12a3 3 0 1 1-4.24-4.24" fill="none" stroke={color} strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
      <Line x1={2} y1={2} x2={22} y2={22} stroke={color} strokeWidth={2} strokeLinecap="round" />
    </Svg>
  );
}

export function ExternalLinkIcon({ size = 18, color = '#B3B3B3' }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24">
      <Path d="M15 3h6v6" fill="none" stroke={color} strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
      <Line x1={10} y1={14} x2={21} y2={3} stroke={color} strokeWidth={2} strokeLinecap="round" />
      <Path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" fill="none" stroke={color} strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
    </Svg>
  );
}
